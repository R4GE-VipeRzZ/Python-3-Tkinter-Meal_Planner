...
def mealsTableFunc(cursor):     #This function is responsible for creating and inserting data into the meals table
    ...
    insert_meals_query = ('INSERT INTO meals (id, name, num_servings, instructions, img_dir)'
        ...
        + '''(30, "Meatballs and sauce", 4, "1. Mix some of the chopped onion and garlic with the mince. Shape the mince into small balls about half the size of a golf ball.^^2. Heat the oil in a non-stick frying pan and brown the meatballs on all sides. Remove and put on to a plate.^^3. Add the remaining onion to the frying pan and cook for 2 to 3 minutes until soft. Add the remaining garlic and cook for another minute.^^4. Add the tomatoes, tomato purée, herbs, mushrooms and peppers to the pan with 150ml water. Bring to the boil, then add the meatballs. Reduce the heat, cover with a lid and simmer for 30 minutes.^^5. About 10 minutes before serving, put the pasta on to cook in plenty of boiling water. Serve with the meatballs and tomato sauce.", "''' + programImagesDir + '''images/meatballs_and_sauce.jpg"),'''
        ...
        + '''(53, "Tuna and bean jackets", 4, "1. Preheat the oven to 200C (fan 180C, gas mark 6). Prick the potatoes, then bake towards the top of the oven for 1 hour, or until tender.^^2. While the potatoes are cooking, mix together the cannellini beans, tuna, pepper, tomatoes, spring onions, vinegar and tomato purée. Season with black pepper.^^3. Split the baked potatoes open and fill them with the salsa mixture. Serve at once.", "''' + programImagesDir + '''images/tuna_and_bean_jackets.jpg"),'''
